...
theme.taglist_font                              = "artwiz lemon 8"
...
theme.fs = lain.widget.fs({
    ...
    notification_preset = { fg = theme.fg_normal, bg = theme.bg_normal, font = "xos4 Terminus 8" },
    settings = function()
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 18, bg = theme.bg_normal, fg = theme.fg_normal, visible = false })
